...
\NSER{You can leave your comment like this}
...
To validate the proposed controller, a numerical simulation is conducted using a nonlinear vehicle model with four-wheel steering and actuator lag.
The following 2-DOF vehicle lateral dynamics \cite{Rajamani:2011aa} are considered:
