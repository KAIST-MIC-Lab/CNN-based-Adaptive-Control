...
for x_idx = 1:1:num_x
    nexttile
    plot(t, X_hist(x_idx,:), 'blue', "LineWidth", line_width); hold on
    plot(t, XD_hist(x_idx,:), 'green', "LineWidth", line_width); hold on
...
for xd_idx = 1:1:num_xd
    nexttile
    plot(t, (XD_hist(xd_idx,:) - X_hist(xd_idx,:)), 'blue', "LineWidth", line_width); hold on
...
for u_idx = 1:1:num_u 
    nexttile 
    plot(t, U_hist(u_idx,:), 'blue', "LineWidth", line_width); hold on
...
% ==============================================================
% FIGURE(4) CNN, FCN weight Frobenius norm
figure(4); clf
