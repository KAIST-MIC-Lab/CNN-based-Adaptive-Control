...
% \end{equation}
$
where $\omega_i,\ \forall i\in\{f,r\}$ denotes the front and rear steering commands, respectively, and $\tau>0$ is the actuator time constant. The control input is then defined as $u \triangleq [\omega_f, \omega_r]^\top$.
